...
//to use the methods in these classes without instantiating them. 
import sg.edu.nus.iss.app.workshop13.model.Contact;
import sg.edu.nus.iss.app.workshop13.util.Contacts;


//Controller annotation to mark as web request handler.
@Controller
@RequestMapping(path="/contact")
public class AddressBookController {

    //Autowired replaces 'new' function. 
    @Autowired
    ...
    //returns addressbook.html which is the addressbook form.
    @GetMapping
